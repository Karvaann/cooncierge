...
interface ExternalFormData {
  ...
  activityinfoform?: Partial<OtherServiceInfoFormData>;
}
      ...
      >
        <div className="px-0 py-1">
          ...
          <div className="w-full border border-[#E2E1E1] rounded-[12px] p-3 mt-4">
            <h1 className="text-[12px] font-medium text-[#020202] mb-2">
              Activity Info
            </h1>
            ...
            <div className="flex flex-col gap-3 w-full mb-4">
              ...
              <div className="flex flex-col w-[35%]">
                ...
                <input
                  ...
                  className="w-full px-3 py-1.5 border border-gray-300 rounded-sm text-[0.75rem] placeholder:text-[#9CA3AF] hover:border-green-400 focus:outline-none focus:ring-1 focus:ring-green-300"
                />
              </div>
              ...
              <div className="flex flex-col w-full">
                ...
                <input
                  ...
                  className="w-[99%] px-3 py-1.5 border border-gray-300 rounded-sm text-[0.75rem] placeholder:text-[#9CA3AF] hover:border-green-400 focus:outline-none focus:ring-1 focus:ring-green-300"
                />
              </div>
            </div>
        ...
        <div className="border border-[#E2E1E1] w-full rounded-[12px] p-3 mt-4">
          <label className="block text-[0.75rem] font-medium text-[#020202]">
            Remarks
          </label>
          ...
          <textarea
            ...
            className={`w-full border border-[#E2E1E1] rounded-md px-2 py-1.5 text-[0.75rem] mt-1 transition-colors hover:border-green-400 focus:ring focus:ring-green-300 ${
      ...
      <CancellationModal
        ...
        onSave={(data) => {
          setFormData((prev) => ({
            ...
            vendorBasePrice: data.vendorBasePrice,
            ...
            vendorIncentiveReceived: data.vendorIncentiveReceived,
...
export default React.memo(ActivityServiceInfoForm);
